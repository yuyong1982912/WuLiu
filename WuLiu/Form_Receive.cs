...
namespace WuLiu
{
	...
	public partial class Form_Receive : Form
	{
		...
		void Button_DelClick(object sender, EventArgs e)
		{
			if (!Blank.IsBlank(textBox_ReceiveId.Text)) {
				...
				switch(result)
				{
					case DialogResult.OK:
						...
						Maticsoft.BLL.Recive BRecive=new Maticsoft.BLL.Recive();
						bool b=BRecive.Delete(Convert.ToInt32(textBox_ReceiveId.Text));
						if (b) {
