...
namespace WuLiu
{
	partial class Form_Main
	{
		...
		private void InitializeComponent()
		{
			...
			this.快递单查找ToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			this.快递单打印ToolStripMenuItem.Size = new System.Drawing.Size(130, 22);
			...
			// 
			// 快递单查找ToolStripMenuItem
			// 
			this.快递单查找ToolStripMenuItem.Name = "快递单查找ToolStripMenuItem";
			this.快递单查找ToolStripMenuItem.Size = new System.Drawing.Size(130, 22);
			this.快递单查找ToolStripMenuItem.Text = "快递单查找";
			this.快递单查找ToolStripMenuItem.Click += new System.EventHandler(this.快递单查找ToolStripMenuItemClick);
			// 
			// Form_Main
			// 
		...
		private System.Windows.Forms.ToolStripMenuItem 快递单查找ToolStripMenuItem;
